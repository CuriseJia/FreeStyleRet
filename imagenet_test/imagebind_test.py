...
from comparison_test import Prompt_ImageBind
from src.utils import setup_seed, getR1Accuary, getR5Accuary


def parse_args():
    parser = argparse.ArgumentParser(description='Parse args for ImageBind test on ImageNet-X Dataset.')
...
def S2IRetrieval(args, model, ori_feat, pair_feat):
    ...
    ori_feat = model(ori_feat, mode='image')
